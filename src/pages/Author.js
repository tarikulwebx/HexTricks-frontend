import { Avatar, Box, Card, CardActions, CardContent, CardMedia, Container, Grid, IconButton, Pagination, Stack, styled, Tooltip, Typography } from '@mui/material'
...
const posts = [
    {
        ...
        categories: [
            {
                name: 'Kickstart',
                url:  '/HexTricks-frontend/category',
            },
            {
                name: 'Web Design',
                url:  '/HexTricks-frontend/category',
                            ...
                            <Container maxWidth='xl'>
                                <Grid container spacing={4}>
                                    <Grid item xs={12} lg={9}>
                                        ...
                                        {/* Social Links */}
                                        <Stack direction='row' spacing={1} sx={{ flexWrap: 'wrap', marginBottom: '2rem' }}>
                                            {
                                                socialLinks.map((social)=>(
                                                    <Tooltip title={social.title} arrow placement='top'>
                                                        <IconButton aria-label={social.title} component='a' href={social.url} target='_blank' size='small' sx={{ backgroundColor: 'rgba(255, 255, 255, 0.975)', color: '#333', padding: '0.575rem', boxShadow: '2', '&:hover': {backgroundColor: '#fff', boxShadow: '5'}}}>
                                                            {social.icon}
                                                        </IconButton>
                                                    </Tooltip>
                                                ))
